...
<!-- [![Build Status](https://github.com/caliconphius/Farey.jl/actions/workflows/CI.yml/badge.svg?branch=master)](https://github.com/caliconphius/Farey.jl/actions/workflows/CI.yml?query=branch%3Amaster) -->
